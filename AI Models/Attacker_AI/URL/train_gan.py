...
def main():
    ...
    # FIX: Use len(tokenizer) to include special tokens like <pad>
    vocab_size = len(tokenizer)
    log(f"Corrected Tokenizer vocab size: {vocab_size}")
    ...
    torch.save({"model_state_dict": model.state_dict(),
                "vocab_size": vocab_size}, final_path) # Save vocab size to be safe

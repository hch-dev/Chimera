...
from .nlp_model import NLPPhishingClassifier
from .cnn_analysis import CNNPhishingClassifier
from .graph_analysis import GNNPhishingClassifier
class EnsemblePredictor:
    ...
    def __init__(
        ...
        self.W_GNN = 0.45
    # ------------------------------------------------------
    # Preprocessing stubs (customize later)
    # ------------------------------------------------------
    ...
    def predict(self, text: str, html_image_tensor, graph_data):
        ...
        # ---- GNN ----
        graph_obj = self.preprocess_graph(graph_data)
        gnn_prob = self.gnn_model(graph_obj).item()
